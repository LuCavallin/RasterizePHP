<?php namespace LuCavallin\RasterizePHP;
    ...
    use \LuCavallin\RasterizePHP\RasterizePHPException as RasterizePHPException;
    ...
    class RasterizePHP {
        ...
        private function getCommand() {
            return escapeshellcmd(implode(" ", [$this->scriptPath, self::FILE_URI.$this->srcPath, $this->dstPath, $this->pageSize]));
        }
